          ...
          <form action="{{route('ReservstionEdit',Auth::user()->id)}}" method="post" class="probootstrap-form">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="fname" name="first_name" value="{{$Reservation->first_name}}" class="@error('first_name') is-invalid @enderror"
                  >
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="lname" name="last_name" value="{{$Reservation->last_name}}" class="@error('last_name') is-invalid @enderror">
                  @error('last_name')
                  <div class="alert alert-danger">{{ $message }}</div>
               @enderror
                </div>
            ...
            <div class="form-group">
                ...
                <div class="form-field">
                  <input type="text" class="form-control" id="email" name="phone_number" value="{{$Reservation->phone_number}}" class="@error('phone_number') is-invalid @enderror">
                  @error('phone_number')
                  <div class="alert alert-danger">{{ $message }}</div>
               @enderror
                </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="form-field">
                   ...
                   <input type="dateTime-local" class="form-control" id="date_arr" name="Start_date" value="{{$Reservation->Start_date}}" class="@error('Start_date') is-invalid @enderror">
                   @error('Start_date')
                   <div class="alert alert-danger">{{ $message }}</div>
                @enderror
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="form-field">
                    ...
                    <input type="datetime-local" class="form-control" id="date_end" name="End_date" value="{{$Reservation->End_date}}" class="@error('End_date') is-invalid @enderror"> 
                    @error('End_date')
                    <div class="alert alert-danger">{{ $message }}</div>
                 @enderror
